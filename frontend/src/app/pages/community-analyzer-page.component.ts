...
import { AnalyzeResponse, BatchSummary } from '../models';
import { ApiService } from '../services/api.service';

@Component({
  selector: 'app-community-analyzer',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
        ...
        <ng-template pTemplate="header">
          ...
          <div class="hero">
            ...
            <div class="hero-badge">
              ...
              AI-анализ сообщества VK
            </div>

            <h1>Проверка аудитории сообщества</h1>

            <p>
              Анализ подписчиков, выявление фейков,
              подозрительных аккаунтов и ML-риск сигналов.
            </p>
        ...
        <div class="search-panel">
          ...
          <div class="input-wrapper">
            ...
            <input
              ...
              [(ngModel)]="groupId"
              class="search-input"
              placeholder="Введите ID или ссылку сообщества"
              (keyup.enter)="analyze()"
            />
...
export class CommunityAnalyzerPageComponent {
  ...
  analyze(): void {
    ...
    this.api
      .analyzeCommunity(this.groupId.trim())
      .pipe(
        finalize(() => {
          this.loading = false;
